...
The p-value here is so small showing that this model is an excellent fit.
...
summary(best.model)
```
The pvalue here is sp small showing that this model is an excellent fit.
...
The p-value is too large to say that there is a difference between the best model which utilizes has four variable and the best model that utilizes two variables 
...
The conclusion based on the automatic selection of the variables there is no real difference in using a model with two variables vs. using one with all of the variables. This was identified through the adjusted r-squared as well as the p-value.
